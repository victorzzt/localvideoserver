...
const messages = {
  en: {
    ...
    thumbnailPending: ({ title }) => `${title}: playback is locked while thumbnails are cached`,
    ...
    setupProgressLabel: "Thumbnail cache progress",
    setupModeTitle: "Thumbnail cache setup",
    setupWaiting: "Waiting for the directory scan…",
    setupCaching: ({ ready, total }) => `${ready} / ${total} thumbnails ready · playback locked`,
    setupReady: ({ total }) => `${total} / ${total} thumbnails ready · playback unlocked`,
    setupFailed: ({ ready, total, failed }) =>
      `${ready} / ${total} thumbnails ready · ${failed} failed · rescan to retry`,
    downloadThumbnailCache: "Download thumbnail.cache",
    preparingThumbnailCache: "Preparing download…",
    thumbnailCacheDownloadFailed: "Could not create thumbnail.cache. Please try again.",
  },
  zh: {
    ...
    thumbnailPending: ({ title }) => `${title}：缩略图缓存完成前暂时锁定播放`,
    ...
    setupProgressLabel: "缩略图缓存进度",
    setupModeTitle: "缩略图缓存构建模式",
    setupWaiting: "等待目录扫描…",
    setupCaching: ({ ready, total }) => `已缓存 ${ready} / ${total} 个缩略图 · 播放已锁定`,
    setupReady: ({ total }) => `已缓存 ${total} / ${total} 个缩略图 · 播放已解锁`,
    setupFailed: ({ ready, total, failed }) =>
      `已缓存 ${ready} / ${total} 个缩略图 · ${failed} 个失败 · 重新扫描可重试`,
    downloadThumbnailCache: "下载 thumbnail.cache",
    preparingThumbnailCache: "正在准备下载…",
    thumbnailCacheDownloadFailed: "无法生成 thumbnail.cache，请重试。",
  },
};
